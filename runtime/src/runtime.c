...
lf_return_t lf_invoke(struct _lf_device *device, struct _lf_module *module, fmr_function function, fmr_type ret, struct _lf_ll *parameters) {
	lf_assert(module, failure, E_NULL, "No module was specified for function invocation.");
	lf_assert(device, failure, E_NULL, "No device was specified for function invocation.")
...
lf_return_t lf_push(struct _lf_device *device, struct _lf_module *module, fmr_function function, void *source, lf_size_t length, struct _lf_ll *parameters) {
	lf_assert(device, failure, E_NO_DEVICE, "NULL device was provided to '%s'.", __PRETTY_FUNCTION__);
	lf_assert(module, failure, E_NULL, "NULL module was provided to '%s'.", __PRETTY_FUNCTION__);
...
lf_return_t lf_pull(struct _lf_device *device, struct _lf_module *module, fmr_function function, void *destination, lf_size_t length, struct _lf_ll *parameters) {
	lf_assert(device, failure, E_NO_DEVICE, "NULL device was provided to '%s'.", __PRETTY_FUNCTION__);
	lf_assert(module, failure, E_NULL, "NULL module was provided to '%s'.", __PRETTY_FUNCTION__);
